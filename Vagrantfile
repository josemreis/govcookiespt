...
# opts = GetoptLong.new(
#   [ '--activation-code', GetoptLong::OPTIONAL_ARGUMENT ],
#   [ '--location', GetoptLong::OPTIONAL_ARGUMENT ]
# )
...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: "sudo apt-get update && sudo apt-get install -y --no-install-recommends libterm-readkey-perl ca-certificates wget expect iproute2 curl procps libnm0"
  ...
  # SHELL
  # # test
  # config.vm.provision "shell", inline: "whereis conda"
  # install openwpm
